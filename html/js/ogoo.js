$(async function() {
    ...
    const translations = {
        'en': {
            ...
            'nav_help': 'Help',
            'nav_help_guide': 'User Guide',
            'nav_help_roles': 'Roles Explained',
            'nav_help_glossary': 'Glossary',
            'start_tour': 'Tour',
            ...
            'help_guide_subtitle': 'Welcome to OG OO! This guide will help you get started.',
            'help_step1_title': '1. Connect Wallet',
            'help_step1_text': 'Click "Connect Wallet" to link your Ethereum wallet (MetaMask recommended).',
            'help_step2_title': '2. Explore Offers',
            'help_step2_text': 'Browse offers to find problems you want to help solve.',
            'help_step3_title': '3. Contribute',
            'help_step3_text': 'Add funds to offers you support. Your contribution gives you voting power.',
            'help_roles_title': 'Roles Explained',
            'role_owner': 'Owner',
            'role_owner_desc': 'Creates the offer and defines the problem.',
            'role_can': 'Can:',
            'role_owner_can1': 'Edit offer before approval',
            'role_owner_can2': 'Approve the offer',
            'role_owner_can3': 'Add/remove observers',
            'role_contributor': 'Contributor',
            'role_contributor_desc': 'Funds the offer and gains voting power.',
            'role_contributor_can1': 'Vote for contenders',
            'role_contributor_can2': 'Cancel contribution',
            'role_contributor_can3': 'View offer details',
            'help_glossary_title': 'Glossary',
            'glossary_offer': 'Offer',
            'glossary_offer_desc': 'A proposal with problem description.',
            'glossary_fund': 'Impact Fund',
            'glossary_fund_desc': 'Pooled money to solve a problem.',
            'glossary_contrib': 'Contribution',
            'glossary_contrib_desc': 'Money added to an offer\'s fund.',
            'glossary_vote': 'Voting Power',
            'glossary_vote_desc': 'Weight of vote based on contribution.',
            'glossary_observer': 'Observer',
            'glossary_observer_desc': 'Trusted participant to validate.',
            'glossary_contender': 'Contender',
            'glossary_contender_desc': 'Person submitting a solution.',
            'glossary_approval': 'Approval',
            'glossary_approval_desc': 'When owner activates the offer.',
            'glossary_period': 'Voting Period',
            'glossary_period_desc': 'Time window for voting.'
        },
        'ru': {
            ...
            'nav_help': 'Помощь',
            'nav_help_guide': 'Руководство',
            'nav_help_roles': 'Роли',
            'nav_help_glossary': 'Глоссарий',
            'start_tour': 'Тур',
            'hero_title': 'Open Group Open Offer',
            ...
            'help_guide_title': 'Руководство',
            'help_guide_subtitle': 'Добро пожаловать в OG OO! Это руководство поможет вам начать.',
            'help_step1_title': '1. Подключить кошелёк',
            'help_step1_text': 'Нажмите "Подключить кошелёк" для привязки кошелька Ethereum (рекомендуется MetaMask).',
            'help_step2_title': '2. Изучить предложения',
            'help_step2_text': 'Просматривайте предложения, чтобы найти проблемы, которые вы хотите помочь решить.',
            'help_step3_title': '3. Сделать вклад',
            'help_step3_text': 'Добавляйте средства в предложения, которые вы поддерживаете. Ваш вклад даёт вам право голоса.',
            'help_roles_title': 'Роли',
            'role_owner': 'Владелец',
            'role_owner_desc': 'Создаёт предложение и определяет проблему.',
            'role_can': 'Может:',
            'role_owner_can1': 'Редактировать до одобрения',
            'role_owner_can2': 'Одобрить предложение',
            'role_owner_can3': 'Добавлять/удалять наблюдателей',
            'role_contributor': 'Вкладчик',
            'role_contributor_desc': 'Финансирует предложение и получает право голоса.',
            'role_contributor_can1': 'Голосовать за претендентов',
            'role_contributor_can2': 'Отменить вклад',
            'role_contributor_can3': 'Просматривать детали',
            'help_glossary_title': 'Глоссарий',
            'glossary_offer': 'Предложение',
            'glossary_offer_desc': 'Предложение с описанием проблемы.',
            'glossary_fund': 'Фонд влияния',
            'glossary_fund_desc': 'Объединённые средства для решения проблемы.',
            'glossary_contrib': 'Вклад',
            'glossary_contrib_desc': 'Деньги, добавленные в фонд предложения.',
            'glossary_vote': 'Право голоса',
            'glossary_vote_desc': 'Вес голоса в зависимости от вклада.',
            'glossary_observer': 'Наблюдатель',
            'glossary_observer_desc': 'Доверенный участник для проверки.',
            'glossary_contender': 'Претендент',
            'glossary_contender_desc': 'Человек, предлагающий решение.',
            'glossary_approval': 'Одобрение',
            'glossary_approval_desc': 'Когда владелец активирует предложение.',
            'glossary_period': 'Период голосования',
            'glossary_period_desc': 'Время для голосования.'
        }
    };
